...
struct RootView: View {
    ...
    @AppStorage("atender.theme") private var themePreference = ThemePreference.auto.rawValue
    ...
    var body: some View {
        ...
        .preferredColorScheme((ThemePreference(rawValue: themePreference) ?? .auto).colorScheme)
    }
